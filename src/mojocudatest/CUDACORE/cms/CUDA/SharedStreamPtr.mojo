...
# In Mojo: Arc[_HeldItem[CUDAStreamType]] — _HeldItem.__del__ returns the
# stream to the pool, mirroring the C++ Deleter exactly.
alias SharedStreamPtr = Arc[_HeldItem[CUDAStreamType]]
